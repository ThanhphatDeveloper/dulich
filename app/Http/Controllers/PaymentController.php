...
class PaymentController extends Controller
{
    ...
    public function test_momo_qr(Request $request){
        ...
        $ipnUrl = "http://localhost:8000/pay";
        $extraData = "";
    ...
    public function momo_payment_qr(Request $request){
        ...
        $amount = $money;
        $orderId = time() ."";
        $redirectUrl = "http://localhost:8000/customer_tour_detail";
        $ipnUrl = "http://localhost:8000/customer_tour_detail";
        $extraData = "";
    ...
    public function vnpay_payment(Request $request){
        ...
        $vnp_Returnurl = "http://localhost:8000/customer_tour_detail";
